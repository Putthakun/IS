...
if page == "Main":
    ...
    st.title("There are several types of machine learning:")
    st.title("TSupervised Learning: The model is trained on labeled data, meaning the input data is paired with the correct output. It learns to map inputs to the correct outputs.")
    st.title("Unsupervised Learning: The model is given data without explicit labels and must find patterns and structure in the data, such as grouping similar data points together.")
    st.title("Reinforcement Learning: The model learns by interacting with an environment and receiving feedback through rewards or penalties, improving over time based on its actions.")
